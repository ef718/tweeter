  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tweet as @tweet" do
        ...
        post :create, {:tweet => { "body" => "invalid value" }}, valid_session
        assigns(:tweet).should be_a_new(Tweet)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tweet" do
        ...
        Tweet.any_instance.should_receive(:update).with({ "body" => "MyText" })
        put :update, {:id => tweet.to_param, :tweet => { "body" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tweet as @tweet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tweet.any_instance.stub(:save).and_return(false)
        put :update, {:id => tweet.to_param, :tweet => { "body" => "invalid value" }}, valid_session
        assigns(:tweet).should eq(tweet)
      end
